...
class TestProductModel(unittest.TestCase):
    ...
    def test_update_without_id_raises_exception(self):
        """Test that updating a Product without an ID raises a DataValidationError."""
    ...
    def test_deserialize_missing_key(self):
        ...
        self.assertIn("missing available", str(context.exception))

    def test_deserialize_invalid_type(self):
        """Test deserialization with invalid type for available."""
        data = {
            "name": "Test Product",
            "description": "A test product",
            "price": "10.99",
    ...
    def test_deserialize_missing_category(self):
        """Test deserialization with a missing category attribute."""
        data = {
            "name": "Test Product",
            "description": "A test product",
            "price": "10.99",
        ...
        # Check that the exception message matches the expected format
        self.assertIn("Invalid product: missing category", str(context.exception))

    def test_deserialize_invalid_category(self):
        """Test deserialization with an invalid category attribute."""
        data = {
            "name": "Test Product",
            "description": "A test product",
            "price": "10.99",
            "available": True,
            "category": "INVALID_CATEGORY",  # This should raise an AttributeError
        }
